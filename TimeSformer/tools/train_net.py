...
def plot_metrics(mode, title, loss_history, acc_history):
    if mode == 'Train' or mode == 'train':
        ...
        plt.plot(loss_history, label=f"{mode} Loss")
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
...
def train(cfg):
    ...
    for cur_epoch in range(start_epoch, cfg.SOLVER.MAX_EPOCH):
        ...
        plot_metrics(mode='Train', title='WLASL1000', loss_history=train_loss_history, acc_history=train_acc_history)
        ...
        if True:
            ...
            plot_metrics(mode='Val', title='WLASL1000', loss_history=[], acc_history=val_acc_history)
